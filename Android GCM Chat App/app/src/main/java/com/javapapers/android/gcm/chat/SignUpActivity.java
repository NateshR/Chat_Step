...
public class SignUpActivity extends ActionBarActivity {
    ...
    private class registerInBackground extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog.setMessage("Please Wait while we register to GCM...");
    ...
    private class SaveUser extends AsyncTask<Void, Void, String> {
        @Override
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = new ProgressDialog(SignUpActivity.this);
            progressDialog.setMessage("Please Wait while we Sign Up to Server...");
